...
<head>
    ...
    <script type="text/javascript">
        $(function(){
            ...
            if(top.topManager){
                //打开左侧菜单中配置过的页面
                top.topManager.reloadPage("testD_list_menu");
            }
            </g:if>
        });
...
<div id="edit-testD" style="margin: 10px;" role="main">
    <g:form action="editTestD" method="post" class="form-horizontal" >
    <g:hiddenField name="id" value="${testDInstance?.id}"/>
