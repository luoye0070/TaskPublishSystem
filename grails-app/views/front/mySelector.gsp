...
<!--搜索条件-->
<div>
    <g:form name="searchForm" action="mySelector" class="form-horizontal">
        ...
        <div>
                    ...
                    <g:each in="${taskInstanceList}" status="i" var="taskInstance">
                        <tr>
                            ...
                            <td>
                                ...
                                <g:if test="${taskInstance.status in [com.lj.tps.status.TaskStatus.TASK_COMPLETE.code,com.lj.tps.status.TaskStatus.TASK_FAILURE.code}]">
                                    <a class="page-action" href="#" target="_self">评价</a>
                                </g:if>
                            </td>
                        </tr>
                    </g:each>
            ...
            <div>
                ...
                <div class="pagination pull-right">
                    <!--分页-->
                    <rmp:paginateInBui action="mySelector" total="${taskInstanceTotal}" prev="&larr;"
                                       next="&rarr;"
                                       params="${params}"/>
                </div>
            </div>
