        ...
        <div class="span16">
            ...
            <div class="clearfix pb-5" style=" position:relative;">
                <div class="pull-left classifyDIV pt-10">
                    <a class="pull-left type-css nosel">${evaluatedPerson?:""}--评价</a>
                    <a  class="pull-left type-css tags ${(params.evaluationLevel!='-1'&& params.evaluationLevel!='0')?'selected':''}"  href="${createLink(controller:'front',action:"showEvaluation",params:[evaluationLevel:1,evaluatedPerson:evaluatedPerson])}">好评(${good?:0})</a>
                    <a  class="pull-left type-css tags ${params.evaluationLevel=='0'?'selected':''}" href="${createLink(controller:'front',action:"showEvaluation",params:[evaluationLevel:0,evaluatedPerson:evaluatedPerson])}" >中评(${mid?:0})</a>
                    <a  class="pull-left type-css tags ${params.evaluationLevel=='-1'?'selected':''}" href="${createLink(controller:'front',action:"showEvaluation",params:[evaluationLevel:-1,evaluatedPerson:evaluatedPerson])}" >差评(${bad?:0})</a>
                </div>
            </div>
                        ...
                        <div class="news-list">
                            ...
                            <div class="clearfix pt-3">
                                <div class="index-news-img span16 pull-left pt-5" style="color:red">
                                    ¥&nbsp;&nbsp;100&nbsp;&nbsp;
                                    <a  target="_blank"  style="font-weight: bold" href="${createLink(action: "showMyTask",params: [id:evaluation.id])}">${evaluation.simpleDesc}</a>
