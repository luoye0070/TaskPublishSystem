                    ...
                    <g:if test="${question || flash.question}">
                        <div class="tips tips-small">
                            <span class="x-icon x-icon-small x-icon-warning"><i
                                    class="icon icon-white icon-question"></i></span>
                    ...
                    <div class="span16">
                        ...
                        <g:form action="saveEvaluation" class="form-horizontal span12">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <a href="${createLink(controller: 'front', action: 'showMyTask', params: [id: taskId])}"
                                       target="_blank"><span class="link">${simpleDesc}</span></a>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <label class=" pull-left radio " for="evaluationLevel"
                                           style="margin-top:0;padding-top:0"><input name="evaluationLevel" type="radio"
                                                                                     value="1">好评&nbsp;&nbsp;</label>
                                    <label class=" pull-left radio " for="evaluationLevel"><input name="evaluationLevel"
                                                                                                  type="radio"
                                                                                                  value="0">中评&nbsp;&nbsp;
                                    </label>
                                    <label class="  pull-left radio " for="evaluationLevel"><input
                                            name="evaluationLevel" type="radio" value="-1">差评</label>
                                </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <textArea name="evaluationContent" style="width: 400px;height: 100px"
                                              placeholder="好评" maxlength="500"></textArea>
                                </div>
