...
<head>
    ...
    <script type="text/javascript">
        \$(function(){
            ...
            if(top.topManager){
                //打开左侧菜单中配置过的页面
                top.topManager.reloadPage("${domainClass.propertyName}_list_menu");
            }
            </g:if>
        });
...
<div id="edit-${domainClass.propertyName}" style="margin: 10px;" role="main">
    <g:form action="edit${className}" method="post" class="form-horizontal" <%=multiPart ? ' enctype="multipart/form-data"' : '' %>>
